...
void main()
{
    ...
    float _188 = fma(exp2(((_180 * (-_180)) * fp_c6_1._m0[9].w) * 1.44269502162933349609375), fp_c6_1._m0[10].x, fma(_178, fp_c6_1._m0[40].x, fp_c6_1._m0[40].y));
    float _190 = clamp((exp2(log2(clamp(max(_176, fp_c1_1._m0[0].y) + (-0.0), 0.0, 1.0)) * fp_c6_1._m0[42].x) * fp_c6_1._m0[42].y) * _104, 0.0, 1.0);
    ...
    vec3 _226 = texture(fp_tex_tcb_1E, vec2(fma(_146, fp_c6_1._m0[50].x, _70.z), _70.w)).xyz;
    ...
    float _264 = fma((-_214) + fp_c6_1._m0[92].x, _262, _214);
    float _266 = fma((-_216) + fp_c6_1._m0[92].y, _262, _216);
    float _268 = fma((-_218) + fp_c6_1._m0[92].z, _262, _218);
    ...
    float _280 = fma(_190, (-_274) + fp_c6_1._m0[43].x, _274);
    float _282 = fma(_190, (-_278) + fp_c6_1._m0[43].y, _278);
    float _284 = fma(_268, -_222, _268);
    float _286 = fma(_280, fma(_104, fp_c6_1._m0[39].x, -_104), _280);
    float _288 = fma(_190, (-_284) + fp_c6_1._m0[43].z, _284);
    float _290 = clamp(_188 + (-0.0), 0.0, 1.0);
    float _292 = fma(_282, fma(_104, fp_c6_1._m0[39].y, -_104), _282);
    float _294 = fma(_280 + (-_286), _290, _286);
    float _296 = fma(_222, _264 + (-0.039999999105930328369140625), fp_c1_1._m0[0].z);
    float _298 = fma(_288, fma(_104, fp_c6_1._m0[39].z, -_104), _288);
    float _300 = _82.x;
