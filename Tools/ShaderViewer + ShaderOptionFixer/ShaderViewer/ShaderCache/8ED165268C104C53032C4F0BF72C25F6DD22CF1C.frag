...
void main()
{
    ...
    float _250 = texture(fp_tex_tcb_1A, vec2(_88, _90)).x * fp_c6_1._m0[18].x;
    ...
    {
        float _294 = 1.0 / fp_c6_1._m0[18].y;
        float _296 = clamp(fma(_234, -fp_c7_1._m0[36].w, 1.0), 0.0, 1.0);
        float _298 = (fp_c6_1._m0[18].y + (-1.0)) * (fp_c6_1._m0[18].y + (-1.0));
        int _300 = 0;
        float _304;
        float _306;
        float _308;
    ...
    float _518 = (fp_c6_1._m0[18].y + (-1.0)) * (fp_c6_1._m0[18].y + (-1.0));
    ...
    float _524 = fma(_518, fp_c1_1._m0[2].x, _518 * exp2((1.0 / fp_c6_1._m0[18].y) * log2(clamp(max(fma(_146, fp_c5_1._m0[23].z, fma(_144, fp_c5_1._m0[23].y, _142 * fp_c5_1._m0[23].x)), fp_c1_1._m0[1].z) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125;
