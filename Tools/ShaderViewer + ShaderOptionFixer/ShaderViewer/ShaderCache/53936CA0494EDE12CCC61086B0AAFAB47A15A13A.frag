...
void main()
{
    ...
    float _296 = fma(fma(_277, _283, -_217), fp_c6_1._m0[54].x, _217);
    ...
    float _302 = fma(fma(_279, _283, -_219), fp_c6_1._m0[54].x, _219);
    float _304 = max(fma(_215, _259, fma(_213, _261, _211 * _263)), fp_c1_1._m0[0].z);
    float _306 = (_289 * 0.5) * _289;
    float _308 = fma(fma(_281, _283, -_221), fp_c6_1._m0[54].x, _221);
    ...
    bool _567 = true;
    if ((_155 < fp_c6_1._m0[53].z) && ((_155 > (-fp_c6_1._m0[53].z)) && ((_153 > (-fp_c6_1._m0[53].z)) && (_153 < fp_c6_1._m0[53].z))))
    {
        _567 = false;
    }
    float _569 = 0.0;
    ...
    if (_567)
    {
        float _581 = max(fp_c6_1._m0[53].x, fp_c1_1._m0[0].x);
        ...
        float _631 = exp2(log2(clamp(max(_591, fp_c1_1._m0[0].x) + (-0.0), 0.0, 1.0)) * fp_c6_1._m0[53].y) * (_235 * (_235 * _235));
        _569 = _631 * ((((fma(_627, -fp_c6_1._m0[52].x, _627) + fp_c6_1._m0[52].x) * _629) * 0.079577468335628509521484375) * (_623 * fp_c5_1._m0[5].x));
        _571 = _631 * ((((fma(_627, -fp_c6_1._m0[52].y, _627) + fp_c6_1._m0[52].y) * _629) * 0.079577468335628509521484375) * (_623 * fp_c5_1._m0[5].y));
        _573 = (fma(_597, fp_c6_1._m0[52].x, _599) * _601.x) * _631;
        _575 = _631 * ((((fma(_627, -fp_c6_1._m0[52].z, _627) + fp_c6_1._m0[52].z) * _629) * 0.079577468335628509521484375) * (_623 * fp_c5_1._m0[5].z));
        _577 = (fma(_597, fp_c6_1._m0[52].y, _599) * _601.y) * _631;
        _579 = (fma(_597, fp_c6_1._m0[52].z, _599) * _601.z) * _631;
    }
