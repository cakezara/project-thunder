...
void main()
{
    ...
    float _486 = fma((_254 * fma(_172, _180.x, _172)) * fp_c6_1._m0[92].x, _484, fma(_270, (_262 * fp_c5_1._m0[5].x) * fma(_239 * (_243 + fma(_243, -_241, _241)), fp_c1_1._m0[1].y, _260 * 0.3183098733425140380859375), _280));
    float _488 = fma((_254 * fma(_174, _180.y, _174)) * fp_c6_1._m0[92].y, _484, fma(_270, (_262 * fp_c5_1._m0[5].y) * fma(_239 * (_245 + fma(_245, -_241, _241)), fp_c1_1._m0[1].y, _256 * 0.3183098733425140380859375), _284));
    float _490 = fma((_254 * fma(_176, _180.z, _176)) * fp_c6_1._m0[92].z, _484, fma(_270, (_262 * fp_c5_1._m0[5].z) * fma(_239 * (_252 + fma(_252, -_241, _241)), fp_c1_1._m0[1].y, _258 * 0.3183098733425140380859375), _282));
