...
void main()
{
    ...
    if (_167)
    {
        ...
        _219 = _235;
        _241 = _233 * fp_c7_1._m0[18].z;
        _243 = _231 * fp_c7_1._m0[18].z;
        _245 = _235 * fp_c7_1._m0[18].z;
    }
    else
    {
        _237 = max(fp_c6_1._m0[8].w, fp_c1_1._m0[0].y) * fp_c6_1._m0[85].x;
    ...
    if (_167)
    {
        ...
        vec3 _309 = texture(fp_tex_tcb_36, vec4(_301 * _307, _303 * _307, _305 * _307, float(12))).xyz;
    ...
    if (floatBitsToInt(_402) != (-1))
    {
        ...
        if ((_420 & 255) == 30)
        {
            ...
            _428 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].x) * _616) * fma(_255, fp_c1_1._m0[2].x, ((fma(_614, -_293, _614) + _293) * _618) * 0.079577468335628509521484375), _620, _438);
            _430 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].z) * _616) * fma(_259, fp_c1_1._m0[2].x, ((fma(_614, -_297, _614) + _297) * _618) * 0.079577468335628509521484375), _620, _442);
    ...
    float _624 = _81.y;
    float _626 = _365 + (-fp_c3_1._m0[13].w);
    float _628 = clamp(fma(_217, -fp_c5_1._m0[23].z, fma(_215, -fp_c5_1._m0[23].y, _213 * (-fp_c5_1._m0[23].x))), 0.0, 1.0);
    float _630 = _624 + (-fp_c3_1._m0[12].w);
    float _632 = fma(_626, _626, fma(_630, _630, _622 * _622));
    float _634 = fma(_289, ((_628 * fp_c5_1._m0[5].x) * fma((fma(_410, -_293, _410) + _293) * _412, fp_c1_1._m0[1].w, _255 * 0.3183098733425140380859375)) * _331, _428) + _241;
    float _636 = fma(_289, ((_628 * fp_c5_1._m0[5].z) * fma((fma(_410, -_297, _410) + _297) * _412, fp_c1_1._m0[1].w, _259 * 0.3183098733425140380859375)) * _331, _430) + _243;
    float _638 = clamp(fma(_289, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _640 = clamp(fma(fma(_365, fp_c5_1._m0[14].z, fma(_624, fp_c5_1._m0[14].y, _367 * fp_c5_1._m0[14].x)), -fp_c5_1._m0[15].x, fp_c5_1._m0[14].w), 0.0, 1.0) * fp_c5_1._m0[13].w;
    float _642 = exp2(log2(clamp(sqrt(_632) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_626 * inversesqrt(_632), fp_c5_1._m0[23].z, fma(_630 * inversesqrt(_632), fp_c5_1._m0[23].y, (_622 * inversesqrt(_632)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _644 = fma(_289, ((_628 * fp_c5_1._m0[5].y) * fma((fma(_410, -_295, _410) + _295) * _412, fp_c1_1._m0[1].w, _285 * 0.3183098733425140380859375)) * _331, _432) + _245;
    float _646 = fma((-_634) + fp_c5_1._m0[13].x, _640, _634);
    float _648 = fma((-_636) + fp_c5_1._m0[13].z, _640, _636);
    float _650 = fma((-_644) + fp_c5_1._m0[13].y, _640, _644);
    ...
    _75.x = fma((-_646) + fma(fma((_642 * fp_c7_1._m0[55].x) * _638, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x), _652, _646);
    _75.y = fma((-_650) + fma(fma((_642 * fp_c7_1._m0[55].y) * _638, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y), _652, _650);
    _75.z = fma((-_648) + fma(fma((_642 * fp_c7_1._m0[55].z) * _638, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z), _652, _648);
