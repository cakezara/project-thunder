...
void main()
{
    ...
    float _511 = fma(fp_c7_1._m0[52].w, fp_c6_1._m0[13].y, fp_c6_1._m0[11].x);
    float _513 = clamp(fma(_297 * _293, fp_c7_1._m0[54].w, (-fp_c7_1._m0[54].w) + 1.0), 0.0, 1.0);
    float _515 = fma(_178, _511, fma(_293, _305, _297 * (fma(_256 * (_260 + fma(_260, -_251, _251)), fp_c1_1._m0[1].x, _249 * 0.3183098733425140380859375) * fma(_245, fp_c5_1._m0[5].x, _287))));
    float _517 = clamp(fma(fma(_237, fp_c5_1._m0[14].z, fma(_503, fp_c5_1._m0[14].y, _227 * fp_c5_1._m0[14].x)), -fp_c5_1._m0[15].x, fp_c5_1._m0[14].w), 0.0, 1.0) * fp_c5_1._m0[13].w;
    float _519 = fma(_180, _511, fma(_293, _307, _297 * (fma(_256 * (_258 + fma(_258, -_251, _251)), fp_c1_1._m0[1].x, _262 * 0.3183098733425140380859375) * fma(_245, fp_c5_1._m0[5].y, _285))));
    float _521 = exp2(log2(clamp(sqrt(_509) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_505 * inversesqrt(_509), fp_c5_1._m0[23].z, fma(_507 * inversesqrt(_509), fp_c5_1._m0[23].y, (_501 * inversesqrt(_509)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _523 = fma(_182, _511, fma(_293, _309, _297 * (fma(_256 * (_264 + fma(_264, -_251, _251)), fp_c1_1._m0[1].x, _275 * 0.3183098733425140380859375) * fma(_245, fp_c5_1._m0[5].z, _283))));
    float _525 = fma((-_515) + fp_c5_1._m0[13].x, _517, _515);
    float _527 = fma((-_519) + fp_c5_1._m0[13].y, _517, _519);
    float _529 = fma((-_523) + fp_c5_1._m0[13].z, _517, _523);
    float _531 = clamp((-exp2((clamp(fma(sqrt(_509), fp_c5_1._m0[12].x, fp_c5_1._m0[11].w), 0.0, 1.0) * (-fp_c7_1._m0[53].x)) * 1.44269502162933349609375)) + 1.0, 0.0, 1.0) * fp_c5_1._m0[10].w;
    _83.x = fma((-_525) + fma(fma((_521 * fp_c7_1._m0[55].x) * _513, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x), _531, _525);
    _83.y = fma((-_527) + fma(fma((_521 * fp_c7_1._m0[55].y) * _513, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y), _531, _527);
    _83.z = fma((-_529) + fma(fma((_521 * fp_c7_1._m0[55].z) * _513, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z), _531, _529);
    _83.w = 1.0;
}
