...
void main()
{
    ...
    float _182 = fma(exp2(log2(clamp(fma(_170, _164, fma(_168, _160, _166 * _158)), 0.0, 1.0)) * fp_c6_1._m0[9].y), fp_c6_1._m0[41].x, fp_c6_1._m0[41].y);
    ...
    float _238 = fma((-_108) + fp_c6_1._m0[93].x, _230, _108);
    float _240 = fma(_238, -fp_c6_1._m0[9].x, _238);
    float _242 = clamp(_182 + (-0.0), 0.0, 1.0);
    float _244 = fma((-_110) + fp_c6_1._m0[93].y, _230, _110);
    float _246 = fma((-_112) + fp_c6_1._m0[93].z, _230, _112);
    float _248 = _156 * _156;
    float _250 = fma(fma(_240, -fp_c6_1._m0[40].x, _240), _242, _240 * fp_c6_1._m0[40].x);
    ...
    float _284 = fma(fma(_270, -fp_c6_1._m0[40].y, _270), _242, _270 * fp_c6_1._m0[40].y);
    ...
    float _288 = fma(fma(_278, -fp_c6_1._m0[40].z, _278), _242, _278 * fp_c6_1._m0[40].z);
    ...
    float _514 = fma(_194.x * fp_c6_1._m0[93].x, _512, fma(_298, _310, _300 * (fma(_286 * (_276 + fma(_276, -_274, _274)), fp_c1_1._m0[1].x, _250 * 0.3183098733425140380859375) * (_290 * fp_c5_1._m0[5].x))));
    float _516 = clamp(fma(_298 * _300, fp_c7_1._m0[54].w, (-fp_c7_1._m0[54].w) + 1.0), 0.0, 1.0);
    float _518 = fma(_194.y * fp_c6_1._m0[93].y, _512, fma(_298, _312, _300 * (fma(_286 * (_280 + fma(_280, -_274, _274)), fp_c1_1._m0[1].x, _284 * 0.3183098733425140380859375) * (_290 * fp_c5_1._m0[5].y))));
    ...
    float _524 = fma(_194.z * fp_c6_1._m0[93].z, _512, fma(_298, _314, _300 * (fma(_286 * (_282 + fma(_282, -_274, _274)), fp_c1_1._m0[1].x, _288 * 0.3183098733425140380859375) * (_290 * fp_c5_1._m0[5].z))));
