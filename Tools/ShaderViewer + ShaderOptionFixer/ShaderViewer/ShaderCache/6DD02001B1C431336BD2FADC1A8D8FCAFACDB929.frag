...
void main()
{
    ...
    float _492 = fma(_192.x * fp_c6_1._m0[93].x, fp_c6_1._m0[11].x, fma(_222, _284, _226 * (fma(_256 * (_264 + fma(_264, -_262, _262)), fp_c1_1._m0[1].x, _258 * 0.3183098733425140380859375) * (_268 * fp_c5_1._m0[5].x))));
    float _494 = fma(_192.z * fp_c6_1._m0[93].z, fp_c6_1._m0[11].x, fma(_222, _286, _226 * (fma(_256 * (_260 + fma(_260, -_262, _262)), fp_c1_1._m0[1].x, _254 * 0.3183098733425140380859375) * (_268 * fp_c5_1._m0[5].z))));
    float _496 = clamp(fma(_222 * _226, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _498 = fma(_192.y * fp_c6_1._m0[93].y, fp_c6_1._m0[11].x, fma(_222, _288, _226 * (fma(_256 * (_252 + fma(_252, -_262, _262)), fp_c1_1._m0[1].x, _266 * 0.3183098733425140380859375) * (_268 * fp_c5_1._m0[5].y))));
