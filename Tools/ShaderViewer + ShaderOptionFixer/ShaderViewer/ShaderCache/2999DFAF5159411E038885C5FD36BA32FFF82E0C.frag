...
void main()
{
    ...
    float _464 = fma(fp_c6_1._m0[11].x, fp_c6_1._m0[7].z, fma(_244, _262, _252 * (fma(_242 * (_240 + fma(_240, -_232, _232)), fp_c1_1._m0[0].w, _205 * 0.3183098733425140380859375) * (_223 * fp_c5_1._m0[5].z))));
    float _466 = _460 + (-fp_c3_1._m0[12].w);
    float _468 = fma(_462, _462, fma(_466, _466, _458 * _458));
    float _470 = fma(fp_c6_1._m0[11].x, fp_c6_1._m0[7].x, fma(_244, _264, _252 * (fma(_242 * (_238 + fma(_238, -_232, _232)), fp_c1_1._m0[0].w, _201 * 0.3183098733425140380859375) * (_223 * fp_c5_1._m0[5].x))));
    float _472 = clamp(fma(fma(_174, fp_c5_1._m0[14].z, fma(_460, fp_c5_1._m0[14].y, _176 * fp_c5_1._m0[14].x)), -fp_c5_1._m0[15].x, fp_c5_1._m0[14].w), 0.0, 1.0) * fp_c5_1._m0[13].w;
    float _474 = clamp(fma(_244 * _252, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _476 = fma(fp_c6_1._m0[11].x, fp_c6_1._m0[7].y, fma(_244, _266, _252 * (fma(_242 * (_236 + fma(_236, -_232, _232)), fp_c1_1._m0[0].w, _203 * 0.3183098733425140380859375) * (_223 * fp_c5_1._m0[5].y))));
    float _478 = exp2(log2(clamp(sqrt(_468) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_462 * inversesqrt(_468), fp_c5_1._m0[23].z, fma(_466 * inversesqrt(_468), fp_c5_1._m0[23].y, (_458 * inversesqrt(_468)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _480 = fma((-_470) + fp_c5_1._m0[13].x, _472, _470);
    float _482 = fma((-_476) + fp_c5_1._m0[13].y, _472, _476);
    float _484 = fma((-_464) + fp_c5_1._m0[13].z, _472, _464);
    ...
    _73.x = fma((-_480) + fma(fma((_478 * fp_c7_1._m0[55].x) * _474, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x), _486, _480);
    _73.y = fma((-_482) + fma(fma((_478 * fp_c7_1._m0[55].y) * _474, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y), _486, _482);
    _73.z = fma((-_484) + fma(fma((_478 * fp_c7_1._m0[55].z) * _474, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z), _486, _484);
    _73.w = 1.0;
}
