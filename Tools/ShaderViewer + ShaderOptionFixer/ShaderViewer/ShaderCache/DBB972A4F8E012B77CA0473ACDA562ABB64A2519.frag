...
void main()
{
    ...
    if (floatBitsToInt(_255) != (-1))
    {
        ...
        if ((_295 & 255) == 30)
        {
            ...
            _303 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].z) * _493) * fma(_263, fp_c1_1._m0[1].z, ((_261 + fma(_261, -_489, _489)) * _495) * 0.079577468335628509521484375), _497, _317);
            ...
            _307 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].x) * _493) * fma(_269, fp_c1_1._m0[1].z, ((_257 + fma(_257, -_489, _489)) * _495) * 0.079577468335628509521484375), _497, _313);
        }
    }
    float _499 = _217 + (-fp_c3_1._m0[11].w);
    float _501 = _78.y;
    float _503 = _219 + (-fp_c3_1._m0[13].w);
    float _505 = fma(_287, _303, _293 * (fma(_267 * (_261 + fma(_261, -_248, _248)), fp_c1_1._m0[1].x, _263 * 0.3183098733425140380859375) * fma(_239, fp_c5_1._m0[5].z, _283)));
    float _507 = _501 + (-fp_c3_1._m0[12].w);
    float _509 = fma(_503, _503, fma(_507, _507, _499 * _499));
    float _511 = clamp(fma(fma(_219, fp_c5_1._m0[14].z, fma(_501, fp_c5_1._m0[14].y, _217 * fp_c5_1._m0[14].x)), -fp_c5_1._m0[15].x, fp_c5_1._m0[14].w), 0.0, 1.0) * fp_c5_1._m0[13].w;
    float _513 = clamp(fma(_293 * _287, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _515 = fma(_287, _305, _293 * (fma(_267 * (_259 + fma(_259, -_248, _248)), fp_c1_1._m0[1].x, _250 * 0.3183098733425140380859375) * fma(_239, fp_c5_1._m0[5].y, _277)));
    float _517 = fma(_287, _307, _293 * (fma(_267 * (_257 + fma(_257, -_248, _248)), fp_c1_1._m0[1].x, _269 * 0.3183098733425140380859375) * fma(_239, fp_c5_1._m0[5].x, _281)));
    float _519 = exp2(log2(clamp(sqrt(_509) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_503 * inversesqrt(_509), fp_c5_1._m0[23].z, fma(_507 * inversesqrt(_509), fp_c5_1._m0[23].y, (_499 * inversesqrt(_509)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _521 = fma((-_517) + fp_c5_1._m0[13].x, _511, _517);
    float _523 = fma((-_515) + fp_c5_1._m0[13].y, _511, _515);
    float _525 = fma((-_505) + fp_c5_1._m0[13].z, _511, _505);
    ...
    _81.x = fma((-_521) + fma(fma((_519 * fp_c7_1._m0[55].x) * _513, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x), _527, _521);
    _81.y = fma((-_523) + fma(fma((_519 * fp_c7_1._m0[55].y) * _513, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y), _527, _523);
    _81.z = fma((-_525) + fma(fma((_519 * fp_c7_1._m0[55].z) * _513, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z), _527, _525);
    _81.w = 1.0;
}
