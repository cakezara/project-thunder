...
void main()
{
    ...
    float _200 = _198.x;
    float _202 = _198.y;
    vec3 _204 = texture(fp_tex_tcb_1E, vec2(fma(_180, fp_c6_1._m0[51].x, _74.z), _74.w)).xyz;
    ...
    float _258 = _196.y + fma((-_190) + fp_c6_1._m0[93].y, _250, _190);
    float _260 = _196.z + fma((-_192) + fp_c6_1._m0[93].z, _250, _192);
    float _262 = _176 * _176;
    float _264 = _196.x + fma((-_188) + fp_c6_1._m0[93].x, _250, _188);
    ...
    if (floatBitsToInt(_292) != (-1))
    {
        ...
        float _340 = clamp(1.0 + (-fp_c6_1._m0[18].x), 0.0, 1.0);
        ...
        do
        {
            ...
            float _448 = exp2(log2(clamp(fma(_168, -clamp((-_400) + (-0.0), 0.0, 1.0), fp_c1_1._m0[0].y), 0.0, 1.0)) * fp_c6_1._m0[18].z) * (fma(_342, fp_c1_1._m0[1].w, exp2(_336 * log2(clamp(max(fma(_156, -_378, fma(_154, -_376, _150 * (-_374))), fp_c1_1._m0[1].z) + (-0.0), 0.0, 1.0))) * _342) + 0.20000000298023223876953125);
            float _450 = _324 + fma((fp_c10_1._m0[int(uint(int(_408)) >> uint(2))][int(_408) & 3] * _446) * fma(_304, fp_c1_1._m0[1].y, _422 * 0.079577468335628509521484375), _340, _338 * ((_448 * (_318 * _444)) * fp_c6_1._m0[18].x));
            float _452 = _326 + fma((fp_c10_1._m0[int(uint(_410) >> uint(2))][_410 & 3] * _446) * fma(_306, fp_c1_1._m0[1].y, ((_294 + fma(_294, -_412, _412)) * _420) * 0.079577468335628509521484375), _340, _338 * ((_448 * (_320 * _444)) * fp_c6_1._m0[18].x));
            float _454 = _328 + fma((fp_c10_1._m0[int(uint(int(_414)) >> uint(2))][int(_414) & 3] * _446) * fma(_308, fp_c1_1._m0[1].y, ((_287 + fma(_287, -_412, _412)) * _420) * 0.079577468335628509521484375), _340, _338 * ((_448 * (_298 * _444)) * fp_c6_1._m0[18].x));
        ...
        if ((_322 & 255) == 30)
        {
            ...
            float _538 = (fma(_342, fp_c1_1._m0[1].w, _342 * exp2(_336 * log2(clamp(max(fma(_156, -_486, fma(_154, -_484, _150 * (-_482))), fp_c1_1._m0[1].z) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125) * exp2(log2(clamp(fma(_168, -clamp((-_500) + (-0.0), 0.0, 1.0), fp_c1_1._m0[0].y), 0.0, 1.0)) * fp_c6_1._m0[18].z);
            ...
            _330 = fma(fma(_340, ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].x) * _540) * fma(_304, fp_c1_1._m0[1].y, ((_285 + fma(_285, -_530, _530)) * _536) * 0.079577468335628509521484375), _338 * ((_538 * (_318 * _534)) * fp_c6_1._m0[18].x)), _542, _348);
            _332 = fma(fma(_340, ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].y) * _540) * fma(_306, fp_c1_1._m0[1].y, ((_294 + fma(_294, -_530, _530)) * _536) * 0.079577468335628509521484375), _338 * ((_538 * (_320 * _534)) * fp_c6_1._m0[18].x)), _542, _350);
            _334 = fma(fma(_340, ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].z) * _540) * fma(_308, fp_c1_1._m0[1].y, ((_287 + fma(_287, -_530, _530)) * _536) * 0.079577468335628509521484375), _338 * ((_538 * (_298 * _534)) * fp_c6_1._m0[18].x)), _542, _352);
        }
    }
    float _544 = _234 + (-fp_c3_1._m0[11].w);
    float _546 = _212 + (-fp_c3_1._m0[12].w);
    float _548 = _238 + (-fp_c3_1._m0[13].w);
    float _550 = clamp(1.0 + (-fp_c6_1._m0[18].x), 0.0, 1.0);
    ...
    float _560 = exp2(log2(clamp(fma(_168, -clamp((-_272) + (-0.0), 0.0, 1.0), fp_c1_1._m0[0].y), 0.0, 1.0)) * fp_c6_1._m0[18].z) * (fma(_556, fp_c1_1._m0[1].w, _556 * exp2((1.0 / fp_c6_1._m0[18].y) * log2(clamp(max(fma(_156, fp_c5_1._m0[23].z, fma(_154, fp_c5_1._m0[23].y, _150 * fp_c5_1._m0[23].x)), fp_c1_1._m0[1].z) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125);
    ...
    float _564 = fma(_296, _330, fma(_256, _550 * ((_310 * fp_c5_1._m0[5].x) * fma(_300 * (_285 + fma(_285, -_283, _283)), fp_c1_1._m0[1].x, _304 * 0.3183098733425140380859375)), _554 * ((_560 * (_318 * fp_c5_1._m0[5].w)) * fp_c6_1._m0[18].x)));
    float _566 = fma(_296, _332, fma(_256, _550 * ((_310 * fp_c5_1._m0[5].y) * fma(_300 * (_294 + fma(_294, -_283, _283)), fp_c1_1._m0[1].x, _306 * 0.3183098733425140380859375)), _554 * ((_560 * (_320 * fp_c5_1._m0[5].w)) * fp_c6_1._m0[18].x)));
    float _568 = fma(_296, _334, fma(_256, _550 * ((_310 * fp_c5_1._m0[5].z) * fma(_300 * (_287 + fma(_287, -_283, _283)), fp_c1_1._m0[1].x, _308 * 0.3183098733425140380859375)), _554 * ((_560 * (_298 * fp_c5_1._m0[5].w)) * fp_c6_1._m0[18].x)));
