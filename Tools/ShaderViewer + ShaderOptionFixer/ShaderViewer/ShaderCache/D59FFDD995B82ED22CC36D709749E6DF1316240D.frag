...
void main()
{
    ...
    else
    {
        ...
        float _269 = fma((-_120) + fp_c6_1._m0[93].x, _267, _120);
        float _271 = fma((-_124) + fp_c6_1._m0[93].z, _267, _124);
        float _273 = fma((-_122) + fp_c6_1._m0[93].y, _267, _122);
    ...
    if (_190)
    {
        ...
        vec3 _347 = texture(fp_tex_tcb_36, vec4(_339 * _345, _341 * _345, _343 * _345, float(12))).xyz;
    ...
    if (floatBitsToInt(_428) != (-1))
    {
        ...
        float _466 = (fp_c6_1._m0[18].y + (-1.0)) * (fp_c6_1._m0[18].y + (-1.0));
        int _468 = 0;
        float _472;
        float _474;
        float _476;
        ...
        do
        {
            ...
            float _570 = fma(_466, fp_c1_1._m0[2].y, exp2((1.0 / fp_c6_1._m0[18].y) * log2(clamp(max(fma(_307, -_500, fma(_303, -_498, _301 * (-_496))), fp_c1_1._m0[2].x) + (-0.0), 0.0, 1.0))) * _466) + 0.20000000298023223876953125;
        ...
        if ((_448 & 255) == 30)
        {
            ...
            float _662 = fma(_466, fp_c1_1._m0[2].y, _466 * exp2((1.0 / fp_c6_1._m0[18].y) * log2(clamp(max(fma(_307, -_610, fma(_303, -_608, _301 * (-_606))), fp_c1_1._m0[2].x) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125;
    ...
    float _678 = (fp_c6_1._m0[18].y + (-1.0)) * (fp_c6_1._m0[18].y + (-1.0));
    float _680 = clamp(fma(_219, -fp_c5_1._m0[23].z, fma(_217, -fp_c5_1._m0[23].y, _215 * (-fp_c5_1._m0[23].x))), 0.0, 1.0);
    float _682 = fma(_678, fp_c1_1._m0[2].y, _678 * exp2((1.0 / fp_c6_1._m0[18].y) * log2(clamp(max(fma(_307, fp_c5_1._m0[23].z, fma(_303, fp_c5_1._m0[23].y, _301 * fp_c5_1._m0[23].x)), fp_c1_1._m0[2].x) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125;
