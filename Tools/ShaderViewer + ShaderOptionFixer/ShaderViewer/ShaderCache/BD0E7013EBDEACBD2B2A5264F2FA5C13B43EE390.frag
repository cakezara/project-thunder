...
void main()
{
    ...
    float _508 = fma(_196.x * fp_c6_1._m0[93].x, fp_c6_1._m0[11].x, fma(_294, _304, _296 * (fma(_284 * (_272 + fma(_272, -_270, _270)), fp_c1_1._m0[1].y, _274 * 0.3183098733425140380859375) * (_286 * fp_c5_1._m0[5].x))));
    float _510 = clamp(fma(_294 * _296, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _512 = fma(_196.y * fp_c6_1._m0[93].y, fp_c6_1._m0[11].x, fma(_294, _306, _296 * (fma(_284 * (_276 + fma(_276, -_270, _270)), fp_c1_1._m0[1].y, _280 * 0.3183098733425140380859375) * (_286 * fp_c5_1._m0[5].y))));
    float _514 = fma(_196.z * fp_c6_1._m0[93].z, fp_c6_1._m0[11].x, fma(_294, _308, _296 * (fma(_284 * (_278 + fma(_278, -_270, _270)), fp_c1_1._m0[1].y, _282 * 0.3183098733425140380859375) * (_286 * fp_c5_1._m0[5].z))));
