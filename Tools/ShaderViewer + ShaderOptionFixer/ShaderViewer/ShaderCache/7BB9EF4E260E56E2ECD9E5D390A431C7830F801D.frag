...
layout(binding = 5) uniform samplerCubeArray fp_tex_tcb_34;
layout(binding = 6) uniform sampler2D fp_tex_tcb_36;
layout(binding = 7) uniform sampler2D fp_tex_tcb_42;
...
void main()
{
    ...
    float _84 = 1.0 / _62.w;
    vec2 _88 = texture(fp_tex_tcb_28, vec2(fma(_62.x * _84, 0.5, 0.5), fma(_62.y * _84, -0.5, 0.5))).xy;
    ...
    vec2 _144 = texture(fp_tex_tcb_36, vec2(_132, (-_142) + (-0.0))).xy;
    float _146 = _144.x;
    float _148 = _144.y;
    float _150 = _118 * _120;
    vec3 _152 = texture(fp_tex_tcb_34, vec4(_134 * _140, _136 * _140, _138 * _140, float(int(clamp(uint(max(roundEven(roundEven(fma(cos(_142 * 3.1415927410125732421875), -5.5, 5.5))), 0.0)), 0u, 65535u))))).xyz;
    float _154 = _68.x;
    float _156 = _68.z;
    ...
    float _220 = clamp((-fma(max((-_88.x) + 1.0, (-_88.y) + 1.0), clamp(_68.w + fp_c7_1._m0[36].z, 0.0, 1.0), fma(texture(fp_tex_tcb_26, vec2((_60.x * gl_FragCoord.w) * _82, (_60.y * gl_FragCoord.w) * _82)).x, -fp_c3_1._m0[41].x, fp_c3_1._m0[41].x))) + 1.0, 0.0, 1.0);
    ...
    if (floatBitsToInt(_198) != (-1))
    {
        ...
        if ((_230 & 255) == 30)
        {
            ...
            float _430 = float((texture(fp_tex_tcb_42, vec2(fma((fma(_156, fp_c10_1._m0[562].z, fma(_346, fp_c10_1._m0[562].y, _154 * fp_c10_1._m0[562].x)) + fp_c10_1._m0[562].w) * _348, 0.5, 0.5), (-fma((fma(_156, fp_c10_1._m0[563].z, fma(_346, fp_c10_1._m0[563].y, _154 * fp_c10_1._m0[563].x)) + fp_c10_1._m0[563].w) * _348, 0.5, 0.5)) + 1.0)).z > fma((fma(_156, fp_c10_1._m0[564].z, fma(_346, fp_c10_1._m0[564].y, _154 * fp_c10_1._m0[564].x)) + fp_c10_1._m0[564].w) * _348, 0.5, 0.5)) || (_394 <= 0.0));
