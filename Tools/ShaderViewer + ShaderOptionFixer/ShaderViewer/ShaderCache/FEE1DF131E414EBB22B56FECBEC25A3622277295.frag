...
void main()
{
    ...
    float _257 = (_192.y * clamp(fma(_188.y, fp_c6_1._m0[83].x, -_190.y) + 1.0, 0.0, 1.0)) * fp_c6_1._m0[101].y;
    ...
    float _265 = _259 * fp_c6_1._m0[101].x;
    float _267 = (_192.z * clamp(fma(_188.z, fp_c6_1._m0[83].x, -_190.z) + 1.0, 0.0, 1.0)) * fp_c6_1._m0[101].z;
