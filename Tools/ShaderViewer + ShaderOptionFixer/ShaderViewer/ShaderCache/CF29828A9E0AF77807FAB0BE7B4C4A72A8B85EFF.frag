...
void main()
{
    ...
    float _513 = fma(_203.x * fp_c6_1._m0[12].x, fp_c6_1._m0[11].x, fma(_299, _309, _301 * (fma(_277 * (_258 + fma(_258, -_256, _256)), fp_c1_1._m0[1].x, _262 * 0.3183098733425140380859375) * fma(_245, fp_c5_1._m0[5].x, _285))));
    float _515 = _509 + (-fp_c3_1._m0[12].w);
    float _517 = fma(_511, _511, fma(_515, _515, _507 * _507));
    float _519 = clamp(fma(fma(_227, fp_c5_1._m0[14].z, fma(_509, fp_c5_1._m0[14].y, _229 * fp_c5_1._m0[14].x)), -fp_c5_1._m0[15].x, fp_c5_1._m0[14].w), 0.0, 1.0) * fp_c5_1._m0[13].w;
    float _521 = clamp(fma(_301 * _299, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _523 = exp2(log2(clamp(sqrt(_517) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_511 * inversesqrt(_517), fp_c5_1._m0[23].z, fma(_515 * inversesqrt(_517), fp_c5_1._m0[23].y, (_507 * inversesqrt(_517)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _525 = fma(_203.y * fp_c6_1._m0[12].y, fp_c6_1._m0[11].x, fma(_299, _311, _301 * (fma(_277 * (_260 + fma(_260, -_256, _256)), fp_c1_1._m0[1].x, _264 * 0.3183098733425140380859375) * fma(_245, fp_c5_1._m0[5].y, _287))));
    float _527 = fma(_203.z * fp_c6_1._m0[12].z, fp_c6_1._m0[11].x, fma(_299, _313, _301 * (fma(_277 * (_266 + fma(_266, -_256, _256)), fp_c1_1._m0[1].x, _268 * 0.3183098733425140380859375) * fma(_245, fp_c5_1._m0[5].z, _289))));
    float _529 = fma((-_513) + fp_c5_1._m0[13].x, _519, _513);
    float _531 = fma((-_525) + fp_c5_1._m0[13].y, _519, _525);
    float _533 = fma((-_527) + fp_c5_1._m0[13].z, _519, _527);
    float _535 = clamp((-exp2((clamp(fma(sqrt(_517), fp_c5_1._m0[12].x, fp_c5_1._m0[11].w), 0.0, 1.0) * (-fp_c7_1._m0[53].x)) * 1.44269502162933349609375)) + 1.0, 0.0, 1.0) * fp_c5_1._m0[10].w;
    _85.x = fma((-_529) + fma(fma((_523 * fp_c7_1._m0[55].x) * _521, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x), _535, _529);
    _85.y = fma((-_531) + fma(fma((_523 * fp_c7_1._m0[55].y) * _521, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y), _535, _531);
    _85.z = fma((-_533) + fma(fma((_523 * fp_c7_1._m0[55].z) * _521, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z), _535, _533);
    _85.w = 1.0;
}
