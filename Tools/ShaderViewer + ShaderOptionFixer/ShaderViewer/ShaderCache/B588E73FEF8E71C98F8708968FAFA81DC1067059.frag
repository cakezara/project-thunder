...
void main()
{
    ...
    float _166 = fma((-_120) + fp_c6_1._m0[92].x, _164, _120);
    ...
    float _174 = _130 * fp_c6_1._m0[92].x;
    ...
    float _182 = fma((-_122) + fp_c6_1._m0[92].y, _164, _122);
    float _184 = fma((-_124) + fp_c6_1._m0[92].z, _164, _124);
    float _186 = (_126.x * fp_c6_1._m0[19].x) * fp_c6_1._m0[92].x;
    float _188 = (_126.z * fp_c6_1._m0[19].z) * fp_c6_1._m0[92].z;
    float _190 = _132 * fp_c6_1._m0[92].y;
    float _192 = _134 * fp_c6_1._m0[92].z;
    ...
    float _204 = (_126.y * fp_c6_1._m0[19].y) * fp_c6_1._m0[92].y;
    float _212;
    float _214;
    float _216;
    float _218;
    ...
    {
        float _206 = fma(_136 + 0.00999999977648258209228515625, 5.0, -fp_c6_1._m0[54].z);
        float _208 = clamp(_206 * (-fp_c6_1._m0[54].y), 0.0, 1.0) * clamp((-clamp(_206 * 100000.0, 0.0, 1.0)) + 1.0, 0.0, 1.0);
        float _210 = _208 * fp_c6_1._m0[55].w;
        _212 = _208;
        _214 = _174 * _210;
        _216 = _190 * _210;
        _218 = _192 * _210;
    ...
    vec3 _280 = texture(fp_tex_tcb_1E, vec2(fma(_276, fp_c6_1._m0[50].x, _80.z), _80.w)).xyz;
    ...
    float _372 = fma(fma(_322, fma(fp_c9_1._m0[32].z, fp_c7_1._m0[71].x, fma(fp_c9_1._m0[32].x, fp_c7_1._m0[69].x, fp_c9_1._m0[32].y * fp_c7_1._m0[70].x)), max(0.0, fma(_338, fp_c5_1._m0[31].x, (fma(_202, fp_c5_1._m0[25].z, fma(_198, fp_c5_1._m0[25].y, _200 * fp_c5_1._m0[25].x)) + fp_c5_1._m0[25].w) + fma(_308, fp_c5_1._m0[28].w, fma(_298, fp_c5_1._m0[28].z, fma(_244, fp_c5_1._m0[28].y, _294 * fp_c5_1._m0[28].x)))))), fma(_360, -_345, _360), fma(_140, (_345 + fma(_345, -_353, _353)) * (_166 * (_280.x * fp_c6_1._m0[49].w)), fma(_345, _284, _286) * _288.x));
    float _374 = clamp(_330 + (-0.0), 0.0, 1.0);
    float _376 = fma(fma(_322, fma(fp_c9_1._m0[32].z, fp_c7_1._m0[71].z, fma(fp_c9_1._m0[32].x, fp_c7_1._m0[69].z, fp_c9_1._m0[32].y * fp_c7_1._m0[70].z)), max(0.0, fma(_338, fp_c5_1._m0[31].z, (fma(_202, fp_c5_1._m0[27].z, fma(_198, fp_c5_1._m0[27].y, _200 * fp_c5_1._m0[27].x)) + fp_c5_1._m0[27].w) + fma(_308, fp_c5_1._m0[30].w, fma(_298, fp_c5_1._m0[30].z, fma(_244, fp_c5_1._m0[30].y, _294 * fp_c5_1._m0[30].x)))))), fma(_364, -_349, _364), fma(_140, (_349 + fma(_349, -_353, _353)) * (_184 * (_280.z * fp_c6_1._m0[49].w)), fma(_349, _284, _286) * _288.z));
    ...
    float _380 = fma(fma(_322, fma(fp_c9_1._m0[32].z, fp_c7_1._m0[71].y, fma(fp_c9_1._m0[32].x, fp_c7_1._m0[69].y, fp_c9_1._m0[32].y * fp_c7_1._m0[70].y)), max(0.0, fma(_338, fp_c5_1._m0[31].y, (fma(_202, fp_c5_1._m0[26].z, fma(_198, fp_c5_1._m0[26].y, _200 * fp_c5_1._m0[26].x)) + fp_c5_1._m0[26].w) + fma(_308, fp_c5_1._m0[29].w, fma(_298, fp_c5_1._m0[29].z, fma(_244, fp_c5_1._m0[29].y, _294 * fp_c5_1._m0[29].x)))))), fma(_362, -_347, _362), fma(_140, (_347 + fma(_347, -_353, _353)) * (_182 * (_280.y * fp_c6_1._m0[49].w)), fma(_347, _284, _286) * _288.y));
    ...
    if (floatBitsToInt(_358) != (-1))
    {
        ...
        float _398 = clamp(1.0 + (-fp_c6_1._m0[17].w), 0.0, 1.0);
        float _400 = (fp_c6_1._m0[18].x + (-1.0)) * (fp_c6_1._m0[18].x + (-1.0));
        int _402 = 0;
        float _406;
        float _408;
        float _410;
        ...
        do
        {
            ...
            float _506 = exp2(log2(clamp(fma(_266, -clamp((-_454) + (-0.0), 0.0, 1.0), fp_c1_1._m0[1].y), 0.0, 1.0)) * fp_c6_1._m0[18].y) * (_168 * (fma(_400, fp_c1_1._m0[3].x, exp2((1.0 / fp_c6_1._m0[18].x) * log2(clamp(max(fma(_262, -_438, fma(_260, -_436, _258 * (-_434))), fp_c1_1._m0[2].w) + (-0.0), 0.0, 1.0))) * _400) + 0.20000000298023223876953125));
            float _508 = fma((_498 * fp_c10_1._m0[int(uint(int(_492)) >> uint(2))][int(_492) & 3]) * fma(_360, fp_c1_1._m0[2].z, ((_345 + fma(_345, -_468, _468)) * _472) * 0.079577468335628509521484375), _398, _396 * ((_506 * (_186 * _504)) * fp_c6_1._m0[17].w)) + _384;
            float _510 = fma((_498 * fp_c10_1._m0[int(uint(_494) >> uint(2))][_494 & 3]) * fma(_362, fp_c1_1._m0[2].z, ((_347 + fma(_347, -_468, _468)) * _472) * 0.079577468335628509521484375), _398, _396 * ((_506 * (_204 * _504)) * fp_c6_1._m0[17].w)) + _386;
            float _512 = fma((_498 * fp_c10_1._m0[int(uint(int(_500)) >> uint(2))][int(_500) & 3]) * fma(_364, fp_c1_1._m0[2].z, ((_349 + fma(_349, -_468, _468)) * _472) * 0.079577468335628509521484375), _398, _396 * ((_506 * (_188 * _504)) * fp_c6_1._m0[17].w)) + _388;
        ...
        if ((_382 & 255) == 30)
        {
            ...
            float _590 = (_168 * (fma(_400, fp_c1_1._m0[3].x, _400 * exp2((1.0 / fp_c6_1._m0[18].x) * log2(clamp(max(fma(_262, -_530, fma(_260, -_528, _258 * (-_526))), fp_c1_1._m0[2].w) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125)) * exp2(log2(clamp(fma(_266, -clamp((-_542) + (-0.0), 0.0, 1.0), fp_c1_1._m0[1].y), 0.0, 1.0)) * fp_c6_1._m0[18].y);
            ...
            _390 = fma(fma(_398, ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].x) * _596) * fma(_360, fp_c1_1._m0[2].z, ((_345 + fma(_345, -_588, _588)) * _592) * 0.079577468335628509521484375), _396 * ((_590 * (_186 * _594)) * fp_c6_1._m0[17].w)), _598, _406);
            _392 = fma(fma(_398, ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].y) * _596) * fma(_362, fp_c1_1._m0[2].z, ((_347 + fma(_347, -_588, _588)) * _592) * 0.079577468335628509521484375), _396 * ((_590 * (_204 * _594)) * fp_c6_1._m0[17].w)), _598, _408);
            _394 = fma(fma(_398, ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].z) * _596) * fma(_364, fp_c1_1._m0[2].z, ((_349 + fma(_349, -_588, _588)) * _592) * 0.079577468335628509521484375), _396 * ((_590 * (_188 * _594)) * fp_c6_1._m0[17].w)), _598, _410);
        }
    }
    float _600 = _94.y;
    float _602 = (fp_c6_1._m0[18].x + (-1.0)) * (fp_c6_1._m0[18].x + (-1.0));
    float _604 = exp2(log2(clamp(fma(_266, -clamp((-_330) + (-0.0), 0.0, 1.0), fp_c1_1._m0[1].y), 0.0, 1.0)) * fp_c6_1._m0[18].y) * (_168 * (fma(_602, fp_c1_1._m0[3].x, _602 * exp2((1.0 / fp_c6_1._m0[18].x) * log2(clamp(max(fma(_262, fp_c5_1._m0[23].z, fma(_260, fp_c5_1._m0[23].y, _258 * fp_c5_1._m0[23].x)), fp_c1_1._m0[2].w) + (-0.0), 0.0, 1.0)))) + 0.20000000298023223876953125));
    float _606 = _312 + (-fp_c3_1._m0[11].w);
    float _608 = _600 + (-fp_c3_1._m0[12].w);
    float _610 = clamp(1.0 + (-fp_c6_1._m0[17].w), 0.0, 1.0);
    ...
    float _618 = fma(_130, _214 + fp_c6_1._m0[13].x, fma(_250, _390, fma(_378, _610 * ((_374 * fp_c5_1._m0[5].x) * uintBitsToFloat(_6[1])), _612 * ((_604 * (_186 * fp_c5_1._m0[5].w)) * fp_c6_1._m0[17].w))));
    float _620 = fma(_132, _216 + fp_c6_1._m0[13].x, fma(_250, _392, fma(_378, _610 * ((_374 * fp_c5_1._m0[5].y) * uintBitsToFloat(_6[0])), _612 * ((_604 * (_204 * fp_c5_1._m0[5].w)) * fp_c6_1._m0[17].w))));
    float _622 = fma(_134, _218 + fp_c6_1._m0[13].x, fma(_250, _394, fma(_378, _610 * ((_374 * fp_c5_1._m0[5].z) * fma((_349 + fma(_349, -_343, _343)) * _351, fp_c1_1._m0[2].y, _364 * 0.3183098733425140380859375)), _612 * ((_604 * (_188 * fp_c5_1._m0[5].w)) * fp_c6_1._m0[17].w))));
