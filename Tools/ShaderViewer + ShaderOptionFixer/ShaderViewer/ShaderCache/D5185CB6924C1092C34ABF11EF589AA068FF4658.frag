...
void main()
{
    ...
    float _512 = fma(_196.x * fp_c6_1._m0[92].x, _508, fma(_294, _304, _296 * (fma(_284 * (_272 + fma(_272, -_270, _270)), fp_c1_1._m0[1].y, _274 * 0.3183098733425140380859375) * (_286 * fp_c5_1._m0[5].x))));
    float _514 = fma(_196.y * fp_c6_1._m0[92].y, _508, fma(_294, _306, _296 * (fma(_284 * (_276 + fma(_276, -_270, _270)), fp_c1_1._m0[1].y, _280 * 0.3183098733425140380859375) * (_286 * fp_c5_1._m0[5].y))));
    ...
    float _518 = fma(_196.z * fp_c6_1._m0[92].z, _508, fma(_294, _308, _296 * (fma(_284 * (_278 + fma(_278, -_270, _270)), fp_c1_1._m0[1].y, _282 * 0.3183098733425140380859375) * (_286 * fp_c5_1._m0[5].z))));
