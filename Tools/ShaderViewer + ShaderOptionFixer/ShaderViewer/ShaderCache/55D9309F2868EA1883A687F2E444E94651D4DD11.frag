...
void main()
{
    ...
    float _219 = max(fma(_146, _206, fma(_144, _204, _140 * _202)), fp_c1_1._m0[0].z) * max(fma(_146, _206, fma(_144, _204, _140 * _202)), fp_c1_1._m0[0].z);
    float _221 = fma(_144, -fp_c5_1._m0[23].y, _140 * (-fp_c5_1._m0[23].x));
    float _223 = fma(_150, 0.5, 0.5);
    float _225 = max(fma(_142, _206, fma(_138, _204, _134 * _202)), fp_c1_1._m0[0].z);
    float _227 = (_223 * 0.5) * _223;
    float _229 = clamp(fma(_146, -fp_c5_1._m0[23].z, _221), 0.0, 1.0);
    float _231 = max(fma(_146, -fp_c5_1._m0[23].z, _221), fp_c1_1._m0[0].z);
    ...
    float _240 = fma(_174, -_176, _174);
    float _242 = exp2(_225 * fma(_225, fp_c1_1._m0[0].w, -6.9831600189208984375));
    float _244 = fma(_170, -_176, _170);
    float _246 = fma(_176, _170 + (-0.039999999105930328369140625), fp_c1_1._m0[0].y);
    ...
    float _250 = (_238 * (1.0 / (_227 + fma(_227, -_231, _231)))) * ((_214 * (1.0 / max(fma(_219, _214 * _214, -_219) + 1.0, fp_c1_1._m0[0].z))) * (_214 * (1.0 / max(fma(_219, _214 * _214, -_219) + 1.0, fp_c1_1._m0[0].z))));
    ...
    float _258 = fma(_184.x, fma(_246, _180, _182), max(0.0, fma(_212, fp_c5_1._m0[31].x, (fma(_146, fp_c5_1._m0[25].z, fma(_144, fp_c5_1._m0[25].y, _140 * fp_c5_1._m0[25].x)) + fp_c5_1._m0[25].w) + fma(_210, fp_c5_1._m0[28].w, fma(_196, fp_c5_1._m0[28].z, fma(_208, fp_c5_1._m0[28].y, _194 * fp_c5_1._m0[28].x))))) * fma(_246, -_244, _244));
    ...
    float _262 = fma(_184.z, fma(_256, _180, _182), max(0.0, fma(_212, fp_c5_1._m0[31].z, (fma(_146, fp_c5_1._m0[27].z, fma(_144, fp_c5_1._m0[27].y, _140 * fp_c5_1._m0[27].x)) + fp_c5_1._m0[27].w) + fma(_210, fp_c5_1._m0[30].w, fma(_196, fp_c5_1._m0[30].z, fma(_208, fp_c5_1._m0[30].y, _194 * fp_c5_1._m0[30].x))))) * fma(_256, -_240, _240));
    ...
    if (floatBitsToInt(_236) != (-1))
    {
        ...
        do
        {
            ...
            float _378 = fma(fp_c10_1._m0[int(uint(int(_334)) >> uint(2))][int(_334) & 3] * _374, fma(_240, fp_c1_1._m0[1].z, ((_256 + fma(_256, -_348, _348)) * _354) * 0.079577468335628509521484375), _268);
            float _380 = fma(fp_c10_1._m0[int(uint(int(_344)) >> uint(2))][int(_344) & 3] * _374, fma(_244, fp_c1_1._m0[1].z, ((_246 + fma(_246, -_348, _348)) * _354) * 0.079577468335628509521484375), _270);
        ...
        if ((_264 & 255) == 30)
        {
            ...
            _272 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].x) * _462) * fma(_244, fp_c1_1._m0[1].z, ((_246 + fma(_246, -_456, _456)) * _460) * 0.079577468335628509521484375), _464, _282);
            _274 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].y) * _462) * fma(_254, fp_c1_1._m0[1].z, ((_252 + fma(_252, -_456, _456)) * _460) * 0.079577468335628509521484375), _464, _284);
            _276 = fma(((fp_c10_1._m0[559].w * fp_c10_1._m0[559].z) * _462) * fma(_240, fp_c1_1._m0[1].z, ((_256 + fma(_256, -_456, _456)) * _460) * 0.079577468335628509521484375), _464, _286);
        }
    }
    float _466 = _198 + (-fp_c3_1._m0[11].w);
    float _468 = _190 + (-fp_c3_1._m0[13].w);
    float _470 = _72.y + (-fp_c3_1._m0[12].w);
    float _472 = fma(_468, _468, fma(_470, _470, _466 * _466));
    float _474 = exp2(log2(clamp(sqrt(_472) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_468 * inversesqrt(_472), fp_c5_1._m0[23].z, fma(_470 * inversesqrt(_472), fp_c5_1._m0[23].y, (_466 * inversesqrt(_472)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _476 = clamp(fma(_248, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _478 = fma(_248, fma(_250 * (_246 + fma(_246, -_242, _242)), fp_c1_1._m0[1].x, _244 * 0.3183098733425140380859375) * (_229 * fp_c5_1._m0[5].x), _272);
    float _480 = fma(_248, fma(_250 * (_252 + fma(_252, -_242, _242)), fp_c1_1._m0[1].x, _254 * 0.3183098733425140380859375) * (_229 * fp_c5_1._m0[5].y), _274);
    float _482 = fma(_248, fma(_250 * (_256 + fma(_256, -_242, _242)), fp_c1_1._m0[1].x, _240 * 0.3183098733425140380859375) * (_229 * fp_c5_1._m0[5].z), _276);
    float _484 = clamp((-exp2((clamp(fma(sqrt(_472), fp_c5_1._m0[12].x, fp_c5_1._m0[11].w), 0.0, 1.0) * (-fp_c7_1._m0[53].x)) * 1.44269502162933349609375)) + 1.0, 0.0, 1.0) * fp_c5_1._m0[10].w;
    _75.x = fma(fma(fma((_474 * fp_c7_1._m0[55].x) * _476, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x) + (-_478), _484, _478);
    _75.y = fma(fma(fma((_474 * fp_c7_1._m0[55].y) * _476, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y) + (-_480), _484, _480);
    _75.z = fma(fma(fma((_474 * fp_c7_1._m0[55].z) * _476, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z) + (-_482), _484, _482);
    _75.w = 1.0;
}
