...
void main()
{
    ...
    float _274 = _41.z;
    float _276 = _41.w;
    _43.x = fma(_190, vp_c5_1._m0[111].x, _72 * vp_c5_1._m0[111].z) + vp_c5_1._m0[112].x;
    _43.y = fma(_190, vp_c5_1._m0[111].y, _72 * vp_c5_1._m0[111].w) + vp_c5_1._m0[112].y;
    _45.w = _39.w;
    float _278 = fma(vp_c8_1._m0[int(uint(_262) >> uint(2))][_262 & 3] + fma(_260, _192, fma(_162, _81, _158 * _70)), _276, fma(vp_c8_1._m0[int(uint(_244) >> uint(2))][_244 & 3] + fma(_242, _192, fma(_170, _81, _166 * _70)), _274, fma(vp_c8_1._m0[int(uint(_208) >> uint(2))][_208 & 3] + fma(_206, _192, fma(_136, _81, _132 * _70)), _272, (vp_c8_1._m0[int(uint(_198) >> uint(2))][_198 & 3] + fma(_196, _192, fma(_90, _81, _86 * _70))) * _270)));
    _47.x = _278;
    float _280 = fma(fma(_260, _200, fma(_162, _138, _158 * _74)), _276, fma(fma(_242, _200, fma(_170, _138, _166 * _74)), _274, fma(fma(_206, _200, fma(_136, _138, _132 * _74)), _272, fma(_196, _200, fma(_90, _138, _86 * _74)) * _270)));
    float _282 = fma(vp_c8_1._m0[int(uint(_226) >> uint(2))][_226 & 3] + fma(_224, _192, fma(_178, _81, _174 * _70)), _276, fma(vp_c8_1._m0[int(uint(_250) >> uint(2))][_250 & 3] + fma(_248, _192, fma(_146, _81, _142 * _70)), _274, fma(vp_c8_1._m0[int(uint(_238) >> uint(2))][_238 & 3] + fma(_236, _192, fma(_118, _81, _114 * _70)), _272, (vp_c8_1._m0[int(uint(_232) >> uint(2))][_232 & 3] + fma(_230, _192, fma(_108, _81, _104 * _70))) * _270)));
    _47.y = _282;
    float _284 = fma(fma(_224, _200, fma(_178, _138, _174 * _74)), _276, fma(fma(_248, _200, fma(_146, _138, _142 * _74)), _274, fma(fma(_236, _200, fma(_118, _138, _114 * _74)), _272, fma(_230, _200, fma(_108, _138, _104 * _74)) * _270)));
    float _286 = fma(fma(_260, _202, fma(_162, _188, _158 * _76)), _276, fma(fma(_242, _202, fma(_170, _188, _166 * _76)), _274, fma(fma(_206, _202, fma(_136, _188, _132 * _76)), _272, fma(_196, _202, fma(_90, _188, _86 * _76)) * _270)));
    float _288 = fma(vp_c8_1._m0[int(uint(_268) >> uint(2))][_268 & 3] + fma(_266, _192, fma(_186, _81, _182 * _70)), _276, fma(vp_c8_1._m0[int(uint(_256) >> uint(2))][_256 & 3] + fma(_254, _192, fma(_154, _81, _150 * _70)), _274, fma(vp_c8_1._m0[int(uint(_220) >> uint(2))][_220 & 3] + fma(_218, _192, fma(_128, _81, _124 * _70)), _272, (vp_c8_1._m0[int(uint(_214) >> uint(2))][_214 & 3] + fma(_212, _192, fma(_98, _81, _94 * _70))) * _270)));
    _47.z = _288;
    float _290 = fma(fma(_224, _202, fma(_178, _188, _174 * _76)), _276, fma(fma(_248, _202, fma(_146, _188, _142 * _76)), _274, fma(fma(_236, _202, fma(_118, _188, _114 * _76)), _272, fma(_230, _202, fma(_108, _188, _104 * _76)) * _270)));
    float _292 = fma(fma(_266, _200, fma(_186, _138, _182 * _74)), _276, fma(fma(_254, _200, fma(_154, _138, _150 * _74)), _274, fma(fma(_218, _200, fma(_128, _138, _124 * _74)), _272, fma(_212, _200, fma(_98, _138, _94 * _74)) * _270)));
    float _294 = fma(fma(_266, _202, fma(_186, _188, _182 * _76)), _276, fma(fma(_254, _202, fma(_154, _188, _150 * _76)), _274, fma(fma(_218, _202, fma(_128, _188, _124 * _76)), _272, fma(_212, _202, fma(_98, _188, _94 * _76)) * _270)));
    ...
    float _296 = inversesqrt(fma(_294, _294, fma(_290, _290, _286 * _286)));
    float _298 = fma(_288, vp_c3_1._m0[0].z, fma(_282, vp_c3_1._m0[0].y, _278 * vp_c3_1._m0[0].x)) + vp_c3_1._m0[0].w;
    float _300 = inversesqrt(fma(_292, _292, fma(_284, _284, _280 * _280)));
    _45.x = _286 * _296;
    _45.y = _290 * _296;
    _45.z = _294 * _296;
    ...
    float _306 = fma(_304, vp_c3_1._m0[8].z, fma(_302, vp_c3_1._m0[8].y, _298 * vp_c3_1._m0[8].x)) + vp_c3_1._m0[8].w;
    gl_Position.z = fma(_304, vp_c3_1._m0[9].z, fma(_302, vp_c3_1._m0[9].y, _298 * vp_c3_1._m0[9].x)) + vp_c3_1._m0[9].w;
    float _308 = fma(_304, vp_c3_1._m0[7].z, fma(_302, vp_c3_1._m0[7].y, _298 * vp_c3_1._m0[7].x)) + vp_c3_1._m0[7].w;
    gl_Position.y = _306;
    float _310 = fma(_304, vp_c3_1._m0[10].z, fma(_302, vp_c3_1._m0[10].y, _298 * vp_c3_1._m0[10].x)) + vp_c3_1._m0[10].w;
    _55.y = _306;
    gl_Position.x = _308;
    _55.x = _308;
    gl_Position.w = _310;
