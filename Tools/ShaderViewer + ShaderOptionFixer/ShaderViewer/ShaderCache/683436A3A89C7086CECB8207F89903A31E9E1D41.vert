...
void main()
{
    ...
    float _178 = _41.y;
    float _180 = _41.x;
    _43.x = fma(_70, vp_c5_1._m0[111].x, _68 * vp_c5_1._m0[111].z) + vp_c5_1._m0[112].x;
    _43.y = fma(_70, vp_c5_1._m0[111].y, _68 * vp_c5_1._m0[111].w) + vp_c5_1._m0[112].y;
    _45.w = _39.w;
    ...
    _47.x = _182;
    float _184 = fma(fma(_162, _176, fma(_108, _158, _104 * _74)), _180, fma(_148, _176, fma(_130, _158, _126 * _74)) * _178);
    float _186 = fma(vp_c8_1._m0[int(uint(_164) >> uint(2))][_164 & 3] + fma(_162, _174, fma(_108, _76, _104 * _72)), _180, (vp_c8_1._m0[int(uint(_150) >> uint(2))][_150 & 3] + fma(_148, _174, fma(_130, _76, _126 * _72))) * _178);
    _47.y = _186;
    float _188 = fma(fma(_112, _172, fma(_92, _81, _88 * _66)), _180, fma(_142, _172, fma(_122, _81, _118 * _66)) * _178);
    _49.x = _182 + (-vp_c3_1._m0[11].w);
    float _190 = fma(vp_c8_1._m0[int(uint(_170) >> uint(2))][_170 & 3] + fma(_168, _174, fma(_100, _76, _96 * _72)), _180, (vp_c8_1._m0[int(uint(_156) >> uint(2))][_156 & 3] + fma(_154, _174, fma(_138, _76, _134 * _72))) * _178);
    float _192 = fma(fma(_162, _172, fma(_108, _81, _104 * _66)), _180, fma(_148, _172, fma(_130, _81, _126 * _66)) * _178);
    _47.z = _190;
    float _194 = fma(fma(_168, _172, fma(_100, _81, _96 * _66)), _180, fma(_154, _172, fma(_138, _81, _134 * _66)) * _178);
    float _196 = fma(fma(_112, _176, fma(_92, _158, _88 * _74)), _180, fma(_142, _176, fma(_122, _158, _118 * _74)) * _178);
    float _198 = fma(fma(_168, _176, fma(_100, _158, _96 * _74)), _180, fma(_154, _176, fma(_138, _158, _134 * _74)) * _178);
    _49.y = _186 + (-vp_c3_1._m0[12].w);
    _49.z = _190 + (-vp_c3_1._m0[13].w);
    float _200 = fma(_190, vp_c3_1._m0[0].z, fma(_186, vp_c3_1._m0[0].y, _182 * vp_c3_1._m0[0].x)) + vp_c3_1._m0[0].w;
    _51.x = fma(_190, vp_c3_1._m0[35].z, fma(_186, vp_c3_1._m0[35].y, _182 * vp_c3_1._m0[35].x)) + vp_c3_1._m0[35].w;
    float _202 = fma(_190, vp_c3_1._m0[1].z, fma(_186, vp_c3_1._m0[1].y, _182 * vp_c3_1._m0[1].x)) + vp_c3_1._m0[1].w;
    float _204 = inversesqrt(fma(_194, _194, fma(_192, _192, _188 * _188)));
    float _206 = inversesqrt(fma(_198, _198, fma(_184, _184, _196 * _196)));
    float _208 = fma(_190, vp_c3_1._m0[2].z, fma(_186, vp_c3_1._m0[2].y, _182 * vp_c3_1._m0[2].x)) + vp_c3_1._m0[2].w;
    _47.w = _208;
    _51.z = fma(_190, vp_c3_1._m0[37].z, fma(_186, vp_c3_1._m0[37].y, _182 * vp_c3_1._m0[37].x)) + vp_c3_1._m0[37].w;
    _53.x = _188 * _204;
    _53.y = _192 * _204;
    _45.x = _196 * _206;
    _45.y = _184 * _206;
    _51.y = fma(_190, vp_c3_1._m0[36].z, fma(_186, vp_c3_1._m0[36].y, _182 * vp_c3_1._m0[36].x)) + vp_c3_1._m0[36].w;
    _53.z = _194 * _204;
    _45.z = _198 * _206;
