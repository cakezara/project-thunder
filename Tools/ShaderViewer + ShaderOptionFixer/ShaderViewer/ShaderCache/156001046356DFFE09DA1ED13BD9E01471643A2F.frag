...
void main()
{
    ...
    vec3 _180 = texture(fp_tex_tcb_1E, vec2(fma(_176, fp_c6_1._m0[51].x, _70.z), _70.w)).xyz;
    ...
    float _506 = fma(_202.x * fp_c6_1._m0[93].x, _504, fma(_267, _306, _294 * ((_275 * fp_c5_1._m0[5].x) * fma(_286 * (_263 + fma(_263, -_284, _284)), fp_c1_1._m0[1].y, _255 * 0.3183098733425140380859375))));
    ...
    float _510 = fma(_202.y * fp_c6_1._m0[93].y, _504, fma(_267, _304, _294 * ((_275 * fp_c5_1._m0[5].y) * fma(_286 * (_259 + fma(_259, -_284, _284)), fp_c1_1._m0[1].y, _257 * 0.3183098733425140380859375))));
    float _512 = clamp(fma(_267 * _294, fp_c7_1._m0[54].w, (-fp_c7_1._m0[54].w) + 1.0), 0.0, 1.0);
    float _514 = fma(_202.z * fp_c6_1._m0[93].z, _504, fma(_267, _308, _294 * ((_275 * fp_c5_1._m0[5].z) * fma(_286 * (_261 + fma(_261, -_284, _284)), fp_c1_1._m0[1].y, _265 * 0.3183098733425140380859375))));
