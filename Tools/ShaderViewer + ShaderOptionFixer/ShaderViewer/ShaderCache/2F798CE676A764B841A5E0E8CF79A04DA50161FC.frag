...
void main()
{
    ...
    float _286 = exp2(log2(clamp((-_183) + 1.0, 0.0, 1.0)) * fp_c6_1._m0[45].y) * fp_c6_1._m0[45].x;
    ...
    float _292 = fma(_112, (max(0.0, fma(_251, fp_c5_1._m0[31].y, (fma(_181, -fp_c5_1._m0[26].z, fma(_177, -fp_c5_1._m0[26].y, _175 * (-fp_c5_1._m0[26].x))) + fp_c5_1._m0[26].w) + fma(_229, fp_c5_1._m0[29].w, fma(_213, fp_c5_1._m0[29].z, fma(_221, fp_c5_1._m0[29].y, _223 * fp_c5_1._m0[29].x))))) * fp_c6_1._m0[46].y) * _286, fma(_211, -fp_c6_1._m0[9].x, _211));
    float _294 = fma(_112, (max(0.0, fma(_251, fp_c5_1._m0[31].x, fma(_229, fp_c5_1._m0[28].w, fma(_213, fp_c5_1._m0[28].z, fma(_221, fp_c5_1._m0[28].y, _223 * fp_c5_1._m0[28].x))) + (fma(_181, -fp_c5_1._m0[25].z, fma(_177, -fp_c5_1._m0[25].y, _175 * (-fp_c5_1._m0[25].x))) + fp_c5_1._m0[25].w))) * fp_c6_1._m0[46].x) * _286, fma(_219, -fp_c6_1._m0[9].x, _219));
    ...
    float _298 = fma(_112, (max(0.0, fma(_251, fp_c5_1._m0[31].z, (fma(_181, -fp_c5_1._m0[27].z, fma(_177, -fp_c5_1._m0[27].y, _175 * (-fp_c5_1._m0[27].x))) + fp_c5_1._m0[27].w) + fma(_229, fp_c5_1._m0[30].w, fma(_213, fp_c5_1._m0[30].z, fma(_221, fp_c5_1._m0[30].y, _223 * fp_c5_1._m0[30].x))))) * fp_c6_1._m0[46].z) * _286, fma(_225, -fp_c6_1._m0[9].x, _225));
