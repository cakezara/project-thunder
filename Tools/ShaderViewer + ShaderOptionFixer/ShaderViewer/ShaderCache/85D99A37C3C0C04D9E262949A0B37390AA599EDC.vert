...
void main()
{
    ...
    float _226 = _41.x;
    float _228 = _41.z;
    _43.x = fma(_81, vp_c5_1._m0[111].x, _68 * vp_c5_1._m0[111].z) + vp_c5_1._m0[112].x;
    _43.y = fma(_81, vp_c5_1._m0[111].y, _68 * vp_c5_1._m0[111].w) + vp_c5_1._m0[112].y;
