...
void main()
{
    ...
    if (floatBitsToInt(_236) != (-1))
    {
        ...
        if ((_266 & 255) == 30)
        {
            ...
            _276 = fma(fma(_248, fp_c1_1._m0[1].y, ((_252 + fma(_252, -_446, _446)) * _464) * 0.079577468335628509521484375) * ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].z) * _466), _468, _288);
            _278 = fma(fma(_240, fp_c1_1._m0[1].y, ((_244 + fma(_244, -_446, _446)) * _464) * 0.079577468335628509521484375) * ((fp_c10_1._m0[559].w * fp_c10_1._m0[559].x) * _466), _468, _284);
        }
    }
    ...
    float _482 = fma(_258, _276, _256 * (fma(_250 * (_252 + fma(_252, -_242, _242)), fp_c1_1._m0[0].w, _248 * 0.3183098733425140380859375) * (_227 * fp_c5_1._m0[5].z)));
    float _484 = fma(_258, _278, _256 * (fma(_250 * (_244 + fma(_244, -_242, _242)), fp_c1_1._m0[0].w, _240 * 0.3183098733425140380859375) * (_227 * fp_c5_1._m0[5].x)));
    float _486 = exp2(log2(clamp(sqrt(_480) * fp_c3_1._m0[15].x, 0.0, 1.0)) * fp_c7_1._m0[54].x) * exp2(fma(fma(_474 * inversesqrt(_480), fp_c5_1._m0[23].z, fma(_478 * inversesqrt(_480), fp_c5_1._m0[23].y, (_470 * inversesqrt(_480)) * fp_c5_1._m0[23].x)), -fp_c7_1._m0[54].y, fp_c7_1._m0[54].y));
    float _488 = clamp(fma(_258 * _256, fp_c7_1._m0[54].w, 1.0 + (-fp_c7_1._m0[54].w)), 0.0, 1.0);
    float _490 = clamp(fma(fma(_194, fp_c5_1._m0[14].z, fma(_472, fp_c5_1._m0[14].y, _188 * fp_c5_1._m0[14].x)), -fp_c5_1._m0[15].x, fp_c5_1._m0[14].w), 0.0, 1.0) * fp_c5_1._m0[13].w;
    float _492 = fma((-_484) + fp_c5_1._m0[13].x, _490, _484);
    float _494 = fma((-_482) + fp_c5_1._m0[13].z, _490, _482);
    float _496 = fma((-_476) + fp_c5_1._m0[13].y, _490, _476);
    ...
    _77.x = max(0.0, min(fma(_498, (-_492) + fma(fma((_486 * fp_c7_1._m0[55].x) * _488, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].x), fp_c7_1._m0[53].w, fp_c5_1._m0[10].x), _492), fp_c6_1._m0[140].x));
    _77.y = max(0.0, min(fma(_498, (-_496) + fma(fma((_486 * fp_c7_1._m0[55].y) * _488, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].y), fp_c7_1._m0[53].w, fp_c5_1._m0[10].y), _496), fp_c6_1._m0[140].x));
    _77.z = max(0.0, min(fma(_498, (-_494) + fma(fma((_486 * fp_c7_1._m0[55].z) * _488, fp_c7_1._m0[54].z, -fp_c5_1._m0[10].z), fp_c7_1._m0[53].w, fp_c5_1._m0[10].z), _494), fp_c6_1._m0[140].x));
    _77.w = 1.0;
}
