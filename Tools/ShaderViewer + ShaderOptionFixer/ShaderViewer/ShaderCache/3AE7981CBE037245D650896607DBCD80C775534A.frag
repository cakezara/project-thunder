...
void main()
{
    ...
    float _236 = exp2(log2(clamp((-_160) + 1.0, 0.0, 1.0)) * fp_c6_1._m0[45].y) * fp_c6_1._m0[45].x;
    float _238 = 1.0 / (_192 + fma(_166, -_192, _166));
    float _240 = fp_c6_1._m0[41].z * fp_c6_1._m0[42].y;
    float _242 = fp_c6_1._m0[41].z * fp_c6_1._m0[42].x;
    float _244 = fma(_236, fp_c6_1._m0[46].y, fma(_102.y, -_98, _102.y));
    float _246 = fma(_236, fp_c6_1._m0[46].x, fma(_102.x, -_98, _102.x));
    float _248 = fma(_236, fp_c6_1._m0[46].z, fma(_102.z, -_98, _102.z));
    float _250 = fp_c6_1._m0[41].z * fp_c6_1._m0[42].z;
